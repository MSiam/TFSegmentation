...
python preprocess_cityscapes_tfrecords.py --root=../../Cityscapes/ --rescale=0.5 --dir=train_extra --out=cscapes_train.h5
python preprocess_cityscapes_tfrecords.py --root=../../Cityscapes/ --rescale=0.5 --dir=val --out=cscapes_val.h5