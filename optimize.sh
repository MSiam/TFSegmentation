...
#--input_graph=~/Desktop/TFSegmentation/graph.pb \
#--input_checkpoint=~/Desktop/TFSegmentation/experiments/coarsepre_fcn8s_shufflenet/checkpoints/best/-236744 \
#--output_graph=~/Desktop/TFSegmentation/graph_frozen.pb --output_node_names=network/output/ArgMax
...
#--in_graph=/home/mg/Desktop/TFSegmentation/graph_frozen.pb \
#--out_graph=/home/mg/Desktop/TFSegmentation/graph_optimized.pb \
#--inputs='import/network/input/Placeholder:0' \
#--outputs='network/output/ArgMax:0' \
#--transforms='
#  strip_unused_nodes()
