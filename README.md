...
<span style="color:red">**NOTE: The pretrained weights for all the implemented models will be released soon. Stay in touch for the updates.**</span>
...
```
## License
This project is licensed under the Apache License 2.0 - [see the LICENSE file for details](https://github.com/MSiam/TFSegmentation/blob/master/LICENSE).
